...
public class SetVariableRequest extends Request {
	public static final String REQUEST_COMMAND = "setVariable";

	public SetVariableRequest.SetVariableArguments arguments;

	public class SetVariableArguments extends Request.RequestArguments {
